...
namespace winrt::HaloDesktop::implementation
{
    ...
    void SearchViewModel::OpenDetail(winrt::Windows::Foundation::IInspectable const&item){if(item){m_catalog->RecordRecent(m_query);LoadRecents();m_navigation->GoTo(::HaloDesktop::Services::Page::Detail,item);}}
