...
{
    DetailEpisodeViewModel::DetailEpisodeViewModel(winrt::HaloDesktop::Episode e):m_episode(std::move(e)){}winrt::hstring DetailEpisodeViewModel::Tag()const{return m_episode.Tag();}winrt::hstring DetailEpisodeViewModel::Title()const{return m_episode.Title();}winrt::hstring DetailEpisodeViewModel::Blurb()const{return m_episode.Blurb();}winrt::hstring DetailEpisodeViewModel::Runtime()const{return m_episode.Runtime();}winrt::hstring DetailEpisodeViewModel::Aired()const{return m_episode.Aired();}winrt::hstring DetailEpisodeViewModel::VideoId()const{return m_episode.VideoId();}double DetailEpisodeViewModel::Progress()const noexcept{return m_episode.Progress();}auto DetailEpisodeViewModel::SavedVisibility()const noexcept->Microsoft::UI::Xaml::Visibility{return m_episode.Downloaded()?Visible:Collapsed;}auto DetailEpisodeViewModel::WatchedVisibility()const noexcept->Microsoft::UI::Xaml::Visibility{return m_episode.Watched()?Visible:Collapsed;}auto DetailEpisodeViewModel::InProgressVisibility()const noexcept->Microsoft::UI::Xaml::Visibility{return !m_episode.Watched()&&m_episode.Progress()>0.02?Visible:Collapsed;}auto DetailEpisodeViewModel::IdleVisibility()const noexcept->Microsoft::UI::Xaml::Visibility{return m_episode.Watched()||m_episode.Progress()>0.02?Collapsed:Visible;}winrt::HaloDesktop::Episode DetailEpisodeViewModel::Episode()const{return m_episode;}
    DetailViewModel::DetailViewModel(::HaloDesktop::Services::AppServices const&s):m_metadata(s.Metadata),m_library(s.Library),m_navigation(s.Navigation),m_downloads(s.Downloads),m_watch(s.WatchState),m_episodes(winrt::single_threaded_observable_vector<winrt::Windows::Foundation::IInspectable>()),m_facts(winrt::single_threaded_observable_vector<winrt::Windows::Foundation::IInspectable>()),m_availability(winrt::single_threaded_observable_vector<winrt::Windows::Foundation::IInspectable>()),m_seasons(winrt::single_threaded_observable_vector<winrt::Windows::Foundation::IInspectable>()){}
