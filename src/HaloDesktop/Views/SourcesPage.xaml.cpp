...
namespace winrt::HaloDesktop::implementation
{
    ...
    void SourcesPage::OnBackClick([[maybe_unused]] winrt::Windows::Foundation::IInspectable const&, [[maybe_unused]] Microsoft::UI::Xaml::RoutedEventArgs const&) { m_viewModel.GoBack(); }
