...
namespace winrt::HaloDesktop::implementation
{
    ...
    winrt::Windows::Foundation::IAsyncAction PlayerPage::StartRequestAsync(winrt::HaloDesktop::PlaybackRequest request)
    {
        ...
        auto session=std::make_shared<::HaloDesktop::Playback::PlaybackSessionController>(services.Playback,services.WatchState,services.SettingsSync,services.PlaybackPreferences,services.ScrubPreview);m_session=session;
